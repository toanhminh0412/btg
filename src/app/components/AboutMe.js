        ...
        <section className="pt-20 px-8 md:px-32">
            <div className="prose max-w-none">
                ...
                <article>
                    ...
                    <div className="relative w-80 aspect-square sm:float-right mt-8 sm:mt-0 md:ms-8 mb-8 not-prose">
                    ...
                    That&apos;s why BTG Immigration Consulting was created to eliminate that sense of isolation and confusion,  and provide a secure,  engagkng and collaborative service. Our goal is to make the process as simple, straightforward, and painless as possible.
                    </p>
                </article>
                <article>
                    <h2>Our Mission</h2>
