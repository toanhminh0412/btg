        ...
        <div className="hero min-h-[24rem]" style={{backgroundImage: 'url(/images/header-new.jpg)'}}>
            ...
            <div className="hero-content text-center">
                <div className="max-w-xl lg:max-w-4xl prose text-white py-10">
                    <h1 className="mb-5 text-3xl font-bold text-white">Welcome to BTG Immigration Consulting - Your expert partner for Canadian Immigration!</h1>
                    <h2 className="mb-7 text-2xl font-normal text-white mt-[5px]">We are better together</h2>
